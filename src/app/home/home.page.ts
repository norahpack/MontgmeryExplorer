...
export class HomePage implements OnInit, AfterViewInit {
	...
	ngAfterViewInit(): void {
		...
		var groverKjellenbergHouse = '<img src = "https://history.montgomeryohio.org/wp-content/uploads/sites/3/2017/07/Stix-Durbrow.jpg" style = "float: right; margin: 5px;">' + '<p><b>Grover-Kjellenberg House, c. 1840</b></p>' + '<p> 10305 Montgomery Road, Montgomery, OH </p>' + '<p>This house was built by Adam Grover from sun-cured bricks made on the property. Mr. Grover gave the property at the corner of Montgomery and Deerfield Roads to establish the Hopewell Cemetery. This house has been a residence, a stagecoach stop, and a tavern.</p>'
